export const TERMS_CONDITIONS = [
  {
    ...
    content: (
      <div>
        <p>
          Our terms and conditions were posted on 17 Jun 2024 and last updated
          on 19 Jun 2024.
        </p>
        <p>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            "Our" in this Agreement) refers to gikijo.com website.
          </li>
          <li>
          ...
          <li>
            <b>Country</b> refers to: Malaysia
          </li>
          <li>
          ...
          <li>
            <b>Promotions</b> refer to contests, sweepstakes or other promotions
          ...
          <li>
            <b>Website</b> refers to gikijo.com, accessible from{' '}
            <a href="https://www.gikijo.com">https://www.gikijo.com</a>
          </li>
          <li>
  ...
  {
    id: 'placing_orders_for_products',
    title: 'Placing Orders for Products',
    content: (
      <div>
        <p>
    ...
    content: (
      <div>
        <p>
          ...
          for any products or services sold through the Company.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <div>
        <p>
          Payment can be made through various methods provided by our
          third-party payment provider, Stripe. This includes major credit and
          debit cards as well as digital wallets.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div>
        ...
        <p>
          ...
          our copyright agent via email gikijomy@gmail.com and include in Your
    ...
    content: (
      <div>
        <p>
          ...
          these Terms at any time with or without prior notice.
        </p>
        <p>
    ...
    content: (
      <div>
        <p>
          ...
          contact us via email gikijomy@gmail.com.
        </p>
      </div>
    ),
  },
